<div>
    <div class="content">
        @if (in_array(auth()->user()->role, ['it-person', 'admin']))
            <div class="row">
                    ...
                    <div class="dash-widget dash2">
                        ...
                        <div class="dash-widgetcontent">
                            <h5><span class="counters"
                                    data-count="{{ $availableDevices }}">{{ $availableDevices }}</span>
                            </h5>
                                        ...
                                        @forelse($recentDevices as $index => $device)
                                            <tr>
                                                ...
                                                <td class="deviceimgname">
                                                    <a href="{{ route('device', $device->id) }}" class="product-img">
                                                        @if ($device->device_image)
                                                            <img src="{{ asset('storage/' . $device->device_image) }}"
                                                                alt="device"
                                                    ...
                                                    <a
                                                        href="{{ route('device', $device->id) }}">{{ $device->device_name }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge bg-secondary">{{ ucfirst($device->status) }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
